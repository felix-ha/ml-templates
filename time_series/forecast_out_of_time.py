...
import numpy as np
import pandas as pd
from data_handler import get_gdp, convert_time_series_to_relative, get_oecd_data, get_predictions_weo
...
model = MLPRegressor(hidden_layer_sizes = (2,), max_iter=200)
