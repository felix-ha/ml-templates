...
batches = get_batches(encoded, batch_size=batch_size, seq_length=seq_length)
...
print("predict: ")
#print(sample(net, 10, prime='Happy ', top_k=None))
...
print(sample(loaded, 10, top_k=5, prime="families "))
